...
def get_mutation_dict(fetch, header, mt_df, cores=8, quality_threshold=25):
    quiet=False
    mt_dict = {}
    idx_counter = 0
...
def main(args):
    ...
    mt_dict = get_mutation_dict(fetch, sam.header, mt_df, cores=args.cores, quality_threshold=args.quality_threshold)
